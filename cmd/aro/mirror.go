...
func mirror(ctx context.Context, log *logrus.Entry) error {
	...
	for _, ref := range []string{
		...
		"registry.access.redhat.com/ubi8/go-toolset:1.21.9",
		...
		"quay.io/app-sre/managed-upgrade-operator:v0.1.1054-39d1fa4",
		...
		// don't perform a no-op when the image exists, so :latest tags get updated
