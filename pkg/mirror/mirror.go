...
func Copy(ctx context.Context, dstreference, srcreference string, dstauth, srcauth *types.DockerAuthConfig, noopWhenExists bool) error {
	...
	_, err = copy.Image(ctx, policyctx, dst, src, &copy.Options{
		...
		OptimizeDestinationImageAlreadyExists: noopWhenExists,
	})
